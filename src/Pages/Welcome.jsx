    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
        ...
        <div className="p-8 bg-gray-800 border-t border-gray-700 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link
            to="/signup"
            className="flex items-center justify-center gap-3 text-lg w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-[1.02] group font-medium"
          >
            Sign Up
            <FiArrowRight className="transition-transform group-hover:translate-x-1" />
          </Link>
